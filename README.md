...
**최수헌** :<br/>모델 F1 스코어 등을 올리는 것이 어려웠습니다. 팀원의 도움을 받아 Epoch단위로 랜덤 샘플링된 데이터 셋을 여러번 학습하는 방법을 적용하니 신기하게도 점수가 잘 나와서 좋았습니다.<br/> 
...
**최수헌** :<br/>타이타닉 컴페티션에 잘 참여하지 못했어서 이 프로젝트의 경험이 더 소중하게 느껴집니다. 데이터 셋 선정 부터 모델 개발 까지, 온전히 한 사이클을 돌려본것이 처음이기에 어렵기도 했지만 예제 코드와 우리들의 친구 GPT 덕분에 잘 마무리 할 수 있었습니다.<br/> 
